...
cd $RPM_BUILD_DIR
unzip $RPM_SOURCE_DIR/irond-0.3.2-src.zip)
...
%setup -q -D -n ifmap-server-0.3.2
%patch0 -p1
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
install -p -D -m 755 %{buildroot}/../../BUILD/ifmap-server-0.3.2/ifmap-server %{buildroot}%{_bindir}
install -d -m 755 %{buildroot}/etc/ifmap-server
install -p -D -m 644 %{buildroot}/../../BUILD/ifmap-server-0.3.2/ifmap.properties %{buildroot}/etc/ifmap-server/
install -p -D -m 644 %{buildroot}/../../BUILD/ifmap-server-0.3.2/basicauthusers.properties %{buildroot}/etc/ifmap-server/
install -p -D -m 644 %{buildroot}/../../BUILD/ifmap-server-0.3.2/authorization.properties %{buildroot}/etc/ifmap-server/
install -p -D -m 644 %{buildroot}/../../BUILD/ifmap-server-0.3.2/log4j.properties %{buildroot}/etc/ifmap-server/
install -p -D -m 644 %{buildroot}/../../BUILD/ifmap-server-0.3.2/publisher.properties %{buildroot}/etc/ifmap-server/
#Create sym links to 
